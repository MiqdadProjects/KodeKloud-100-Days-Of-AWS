...
- **IAM Roles:** An identity that you can create in your account that has specific permissions. Unlike an IAM user, a role isn't associated with a single person; it's dynamically assumed by trusted entities (like an EC2 instance) to securely access other AWS services without hardcoding credentials.
