...
- **EBS GP3 Volumes:** General Purpose SSD (gp3) volumes are a generation of Amazon EBS storage that predictably balances price and performance for a wide variety of transactional workloads.
