...
- **S3 Versioning:** The act of keeping multiple variants of an object in the same S3 bucket to protect against accidental overwrites or unauthorized deletions.
